...
//	}
//
//	@GetMapping("/") public String home(HttpServletRequest req, Model model) {
//  int start,psize; String page = req.getParameter("pageno");
//  if(page==null||page.equals("")) { page="1"; } int pno =
//  Integer.parseInt(page); start = (pno-1)10;
//  psize = 10; ArrayList<mallDTO>
//  alMall = mdao.getList(start, psize);
//  
//  int cnt = mdao.getTotal(); int pagecount = (int) Math.ceil(cnt/10.0);
//  
//  
//  String pagestr=""; for(int i=1; i<=pagecount; i++) { if(pno==i) { pagestr +=
//  i+"&nbsp;&nbsp;"; }else {
//  pagestr+="<a href='/?pageno="+i+"'>"+i+"</a>&nbsp;&nbsp;"; } }
//  
//  model.addAttribute("pagestr",pagestr); model.addAttribute("mlist",alMall);
//  
//  HttpSession s = req.getSession();
//  
//  String id = (String) s.getAttribute("id"); if(id==null || id.equals("")) {
//  model.addAttribute(
//  "infoline","<a href='/gologin'>로그인</a>&nbsp;&nbsp;<a href='/gosignup'>회원가입</a>"
//  );
//  
//  }else { //
//  model.addAttribute("img","<img src='img/"+s.getAttribute("selficon")+"'>");
//  
//  model.addAttribute("infoline",
//  id+"&nbsp;&nbsp;<button id=logout>로그아웃</button>");
...
//
	...
	public String dosignup(HttpServletRequest req) {
		...
		try {
			...
			int cnt = mdao.signup(id, passcode1, name, mobile, email, address);
